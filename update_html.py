        ...
        <main>
            ...
            <div id="panel-overview" class="tab-panel active">
                ...
                <div class="grid-3">
                    ...
                    <div class="glass-card">
                        ...
                        <p style="font-size: 0.95rem; color: #CBD5E1;">
                            الاعتماد على واجهات برمجة مفتوحة (APIs) مثل NASA GPM و Sentinel، وتطبيق معادلات واضحة بدلاً من تدريب نماذج ML معقدة وخطرة في 24 ساعة.
                        </p>
                    </div>
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="cairo-heading" style="color: var(--color-text-bright);">5. عدالة الحرارة (Heat Justice)</td>
                                <td>تخطيط حضري</td>
                                <td>كشف الجزر الحرارية بعمان الشرقية</td>
                                <td style="font-weight: 700; color: var(--color-muted);">عالية جداً</td>
                                <td><span class="badge badge-secondary"><i class="fa-solid fa-temperature-arrow-up"></i> أثر اجتماعي كبير</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div id="panel-najji" class="tab-panel">
                <div class="section-header">
                    ...
                    <h2 class="section-title">نجّي (Najji): نظام الإنذار المبكر من السيول الفجائية</h2>
                    <p class="section-desc">تحليل بيانات الهطول المطري من الأقمار الصناعية وربطها بالتضاريس الجبلية لتوقع السيول قبل وصولها للوديان السياحية والمأهولة.</p>
                </div>
                ...
                <div class="diagram-container">
                    <svg class="diagram-svg" viewBox="0 0 800 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="80" y="135" fill="#94A3B8" font-family="Tajawal" font-size="11" text-anchor="middle">بيانات الهطول المطري اللحظية</text>
                        ...
                        <text x="285" y="110" fill="#FFFFFF" font-family="Cairo" font-size="14" font-weight="700" text-anchor="middle">SRTM DEM</text>
                        <text x="285" y="135" fill="#94A3B8" font-family="Tajawal" font-size="11" text-anchor="middle">نموذج الارتفاع وتحديد الأحواض</text>
                        ...
                        <text x="500" y="110" fill="#FFFFFF" font-family="Cairo" font-size="14" font-weight="700" text-anchor="middle">Hydro-Logic Engine</text>
                        <text x="500" y="135" fill="#94A3B8" font-family="Tajawal" font-size="11" text-anchor="middle">حساب مسار السيل وسرعته</text>
                        ...
                        <text x="715" y="110" fill="#FFFFFF" font-family="Cairo" font-size="14" font-weight="700" text-anchor="middle">Alert Dashboard</text>
                        <text x="715" y="135" fill="#94A3B8" font-family="Tajawal" font-size="11" text-anchor="middle">إنذار ذكي مستهدف جغرافياً</text>
                    </svg>
                </div>
                ...
                <div class="split-2">
                    <div class="glass-card go-card">
                        <h3 class="cairo-heading" style="color: var(--color-go); margin-bottom: 1rem; font-size: 1.25rem;">
                            <i class="fa-solid fa-check-double" style="margin-left: 0.5rem;"></i> لماذا نجّي أسهل برمجياً لـ 24 ساعة؟
                        </h3>
                        <p style="font-size: 0.95rem; color: #E2E8F0; margin-bottom: 0.75rem;">
                            <strong>غياب التعقيد الراداري:</strong> لا حاجة لمعالجة صور SAR معقدة أو استخدام SNAP. البيانات المطريّة عبارة عن مصفوفات بسيطة وسهلة التحميل.
                        </p>
                        <p style="font-size: 0.95rem; color: #CBD5E1;">
                            <strong>التحضير المسبق:</strong> يمكنك تحميل نموذج الارتفاع (DEM) الخاص بالأردن قبل الهاكاثون وتحديد حدود أحواض الوديان الخطرة (زرقاء ماعين، الموجب، البتراء). أثناء الهاكاثون، تركز فقط على سحب بيانات المطر وربطها بالواجهة.
                        </p>
                    </div>
                    ...
                    <div class="glass-card fallback-card">
                        <h3 class="cairo-heading" style="color: var(--color-fallback); margin-bottom: 1rem; font-size: 1.25rem;">
                            <i class="fa-solid fa-map-location-dot" style="margin-left: 0.5rem;"></i> خطة الـ Killer Demo
                        </h3>
                        <p style="font-size: 0.95rem; color: #E2E8F0; margin-bottom: 0.75rem;">
                            السر في الفوز هو كيفية استعراض النظام.
                        </p>
                        <ul class="details-list">
                            <li>سحب بيانات الهطول لتاريخ 25 أكتوبر 2018.</li>
                            <li>تغذية النظام بها كما لو كانت "مباشرة".</li>
                            <li>جعل الواجهة تُضيء وادي زرقاء ماعين باللون الأحمر مع عداد تنازلي (45 دقيقة لوصول السيل).</li>
                            <li>عرض رسالة: "كان يمكن لهذه الرسالة أن تصل لهواتف الضحايا قبل الكارثة بـ 45 دقيقة".</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div id="panel-other-ideas" class="tab-panel">
                <div class="section-header">
                    ...
                    <h2 class="section-title">بنك الأفكار المجتمعية العميقة</h2>
                    <p class="section-desc">إذا قررت في اللحظة الأخيرة تغيير المشروع، هذه هي الأفكار التي تحمل وزناً حقيقياً في سياق الأردن.</p>
                </div>

                <div class="grid-3">
                    <div class="glass-card kill-card" style="border-right-color: var(--primary);">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem;">
                            <h4 class="cairo-heading" style="color: var(--primary); font-size: 1.15rem;">عدالة الحرارة (Heat Justice)</h4>
                            <i class="fa-solid fa-temperature-arrow-up" style="font-size: 1.5rem; color: var(--primary);"></i>
                        </div>
                        <p style="font-size: 0.9rem; color: #E2E8F0; margin-bottom: 1rem;">
                            خريطة لمدينة عمان تستخدم بيانات Landsat الحرارية لكشف الفروق المرعبة في الحرارة بين عمان الغربية (الخضراء) وعمان الشرقية الإسمنتية.
                        </p>
                        ...
                        <span style="font-size: 0.8rem; color: var(--color-muted); display: block;">
                            <i class="fa-solid fa-circle-info"></i> رسالة اجتماعية قوية حول العدالة المناخية.
                        </span>
                    </div>
                    ...
                    <div class="glass-card kill-card" style="border-right-color: #EAB308;">
                        ...
                        <p style="font-size: 0.9rem; color: #E2E8F0; margin-bottom: 1rem;">
                            نظام دمج بيانات الغبار الفضائي (MODIS/Sentinel-5P) مع اتجاه الرياح لتحذير مرضى الربو والمستشفيات قبل العواصف الرملية في الصحراء الشرقية.
                        </p>
                        <hr style="border: 0; border-top: 1px solid rgba(255, 255, 255, 0.05); margin-bottom: 0.75rem;">
                        <span style="font-size: 0.8rem; color: var(--color-muted); display: block;">
                    ...
                    <div class="glass-card">
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                <div class="timeline-header">
                                    <span class="timeline-title">خوارزمية الإنذار (The Core)</span>
                                    <span class="timeline-time">الساعة 4 - 10</span>
                                </div>
                                <p class="timeline-desc">كتابة معادلة بسيطة: إذا تجاوز الهطول في مساحة الحوض (X) كمية (Y) ملم خلال ساعة -> تفعيل الإنذار.</p>
                            </div>
                ...
                <div class="pitch-deck">
                    <div class="pitch-screen">
                        ...
                        <div class="pitch-slide" data-slide="3">
                            ...
                            <p class="slide-body">
                                "نقدم لكم 'نجّي'. نظام يسحب بيانات الهطول المطري اللحظية من أقمار NASA GPM، ويحللها فورياً بناءً على خرائط الارتفاعات الجبلية للأردن، ليتوقع مسار السيل قبل وصوله بمدة كافية."
                            </p>
                            <div class="slide-notes">
                                <h5>💡 ملاحظات الحكام والأداء:</h5>
                                <p>اشرح البنية التقنية بوضوح وسرعة. اذكر أسماء الأقمار والوكالات (NASA، Copernicus) لإضفاء المصداقية التقنية القوية.</p>
                            </div>
                        </div>
